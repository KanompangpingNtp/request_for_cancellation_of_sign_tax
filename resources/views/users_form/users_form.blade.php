...
<div class="container">
    <form action="{{ route('form.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group col-md-3 mb-3">
            ...
            <input type="text" id="guest_location" name="guest_location" class="form-control" value="{{ old('guest_location') }}">
        </div>

        <div class="form-group col-md-3">
            <label for="request_date">วันที่กรอกแบบฟอร์ม</label>
            <input type="date" id="request_date" name="request_date" class="form-control" value="{{ old('request_date') }}">
        </div>
        <br>

        <h4 class="mb-2">ข้อมูลผู้กรอกฟอร์ม</h4>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-2 mb-3">
                ...
                <input type="number" id="guest_age" name="guest_age" class="form-control" value="{{ old('guest_age') }}">
            </div>

            <div class="form-group col-md-2 mb-3">
                <label for="guest_nationality">สัญชาติ</label>
                <input type="text" id="guest_nationality" name="guest_nationality" class="form-control" value="{{ old('guest_nationality') }}">
            </div>

            <div class="form-group col-md-2 mb-3">
                <label for="guest_ethnicity">เชื้อชาติ</label>
                <input type="text" id="guest_ethnicity" name="guest_ethnicity" class="form-control" value="{{ old('guest_ethnicity') }}">
            </div>

            <div class="form-group col-md-3 mb-3">
                <label for="guest_house_number">อยู่บ้านเลขที่</label>
                <input type="text" id="guest_house_number" name="guest_house_number" class="form-control" value="{{ old('guest_house_number') }}">
            </div>

            <div class="form-group col-md-3 mb-3">
                <label for="guest_village">หมู่ที่</label>
                <input type="text" id="guest_village" name="guest_village" class="form-control" value="{{ old('guest_village') }}">
            </div>

            <div class="form-group col-md-3 mb-3">
                <label for="guest_road">ถนน</label>
                <input type="text" id="guest_road" name="guest_road" class="form-control" value="{{ old('guest_road') }}">
            </div>

            <div class="form-group col-md-3 mb-3">
                <label for="guest_alley">ตรอก/ซอย</label>
                <input type="text" id="guest_alley" name="guest_alley" class="form-control" value="{{ old('guest_alley') }}">
            </div>

            <div class="form-group col-md-3 mb-3">
                <label for="guest_subdistrict">ตำบล</label>
                <input type="text" id="guest_subdistrict" name="guest_subdistrict" class="form-control" value="{{ old('guest_subdistrict') }}">
            </div>

            <div class="form-group col-md-3 mb-3">
                <label for="guest_district">อำเภอ</label>
                <input type="text" id="guest_district" name="guest_district" class="form-control" value="{{ old('guest_district') }}">
            </div>

            <div class="form-group col-md-3 mb-3">
                <label for="guest_province">จังหวัด</label>
                <input type="text" id="guest_province" name="guest_province" class="form-control" value="{{ old('guest_province') }}">
            </div>

            <div class="form-group col-md-3 mb-3">
                <label for="guest_zipcode">รหัสไปรษณีย์</label>
                <input type="text" id="guest_zipcode" name="guest_zipcode" class="form-control" value="{{ old('guest_zipcode') }}">
            </div>
        </div>
        <br>

        <!-- Form Detail Location Section -->
        <h4 class="mb-2">ข้อมูลตำแหน่ง</h4>
       ...
       <br>
        ...
        <h4 class="mb-2">รายละเอียดป้าย</h4>
