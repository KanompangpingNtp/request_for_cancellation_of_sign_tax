                ...
                <div class="card-body">
                    <form action="{{ route('register.submit') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nationality" name="nationality" placeholder="สัญชาติ" required>
                        </div>
                        <div class="mb-3">
                            <label for="ethnicity" class="form-label">เชื้อชาติ</label>
                            <input type="text" class="form-control" id="ethnicity" name="ethnicity" placeholder="เชื้อชาติ" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="alley" name="alley" placeholder="ตรอก/ซอย" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="zipcode" name="zipcode" class="form-control" placeholder="รหัสไปรษณีย์" required>
                        </div>
                        <div class="d-grid">
